const App = {
  ...
  async renderBenevoles(){
    ...
    el.innerHTML=`<div class="card">
      <div class="chips" style="justify-content:space-between"><h2>Bénévoles</h2><button class="btn btn-primary" onclick="App.modalAddVol()">+ Bénévole</button></div>
  ...
  async renderAdmin(){
    ...
    el.innerHTML=`<div class="card">
      <div class="chips" style="justify-content:space-between"><h2>Utilisateurs</h2><button class="btn btn-primary" onclick="App.modalAddUser()">+ Utilisateur</button></div>
